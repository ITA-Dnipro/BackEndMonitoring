...
/// <example>
///		auto* testLogger1       = new CLogger("TestName", ELogLevel::DEBUG);
///		const auto* testLogger2 = std::move(*testBuilder1);
/// </example>
CLogger& CLogger::operator=(CLogger&&) noexcept = default;

std::ostream& CLogger::PrintLogInfo(const std::string & info, std::ostream & stream) const
{
